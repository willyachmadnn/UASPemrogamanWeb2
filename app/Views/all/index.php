...
<div class="container" style="padding-top: 10px; padding-bottom: 8px;">
    ...
    <form class="row g-2 mb-2" method="get" action="<?= base_url('list') ?>">
        <div class="col-md-6 col-sm-12">
            <input type="text" name="q" class="form-control border border-dark rounded-0"
                placeholder="Masukkan kata kunci" value="<?= esc($_GET['q'] ?? '') ?>">
        </div>
        <div class="col-md-3 col-sm-6">
            <select class="form-select border border-dark rounded-0" name="status">
    ...
    <div class="table-responsive" style="min-height:535px;">
        <table class="table table-bordered border-black table-striped align-middle text-center">
